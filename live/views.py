...
def about(request):
    ...
    return render(request,'covid/about_old.html', {'result':results})
...
def india(request):
    ...
    return render(request, 'covid/india.html',{'z1':z1,'z2':z2,'z3':z3,'z4':z4,'state':ee,'district':er,'d0':d0,'d1':d1,'d2':d2,'d3':d3,'e0':e0,'e1':e1})
'''
